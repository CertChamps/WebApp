import{b as _,c as R,C,d as q,E as fe,o as L,F as Be,g as Ve,v as We,i as Ge,e as Je,f as D,h as A,W as ze}from"./index-6yGlCoUY.js";const le="@firebase/installations",H="0.6.24";/**
 * @license
 ...
 */const pe=1e4,ge=`w:${H}`,he="FIS_v2",Ye="https://firebaseinstallations.googleapis.com/v1",Qe=3600*1e3,Xe="installations",Ze="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ne="firebase-messaging-database",ie=2,p="firebase-messaging-store",l="firebase-messaging-fid-registration-store",Wt={openDB:L,deleteDB:A};let oe=Wt,k=null;function Gt(e,t,n){switch(t){case 0:if(e.createObjectStore(p),n===1)break;case 1:n===2&&e.createObjectStore(l)}}function re(e){return{upgrade:(t,n)=>{Gt(t,n,e)},blocked:()=>{},blocking:(t,n,i)=>{k=null,i.target?.close()},terminated:()=>{k=null}}}function T(){return k||(k=oe.openDB(ne,ie,re(2)).catch(()=>oe.openDB(ne,ie-1,re(1)))),k}function Me(e,t){return e.objectStoreNames.contains(t)}function W(e){if(!Me(e,l))throw c.create("fid-registration-idb-schema-unavailable")}async function Pe(e){const t=I(e),i=await(await T()).transaction(p).objectStore(p).get(t);if(i)return i;{const o=await Ut(e.appConfig.senderId);if(o)return await G(e,o),o}}async function G(e,t){const n=I(e),i=await T(),o=[p],r=Me(i,l);r&&o.push(l);const a=i.transaction(o,"readwrite");return await a.objectStore(p).put(t,n),r&&await a.objectStore(l).delete(n),await a.done,t}async function Jt(e){const t=I(e),i=(await T()).transaction(p,"readwrite");await i.objectStore(p).delete(t),await i.done}async function J(e){const t=I(e),n=await T();return W(n),await n.transaction(l).objectStore(l).get(t)}async function zt(e,t){const n=I(e),i=await T();W(i);const o=i.transaction([p,l],"readwrite");return await o.objectStore(l).put(t,n),await o.objectStore(p).delete(n),await o.done,t}async function Yt(e){const t=I(e),n=await T();W(n);const i=n.transaction(l,"readwrite");await i.objectStore(l).delete(t),await i.done}function I({appConfig:e}){return e.appId}const ae="@firebase/messaging",j="0.13.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qt=3,Xt=1e3;async function Zt(e,t){const n=await E(e),i=z(t,e.appConfig.appName,!1),o={method:"POST",headers:n,body:JSON.stringify(i)};let r;try{r=await(await fetch(v(e.appConfig),o)).json()}catch(a){throw c.create("token-subscribe-failed",{errorInfo:a?.toString()})}if(r.error){const a=r.error.message;throw c.create("token-subscribe-failed",{errorInfo:a})}if(!r.token)throw c.create("token-subscribe-no-token");return r.token}async function en(e,t){const n=await E(e),i=z(t,e.appConfig.appName,!0),o={method:"POST",headers:n,body:JSON.stringify(i)};let r;try{r=await an(()=>fetch(v(e.appConfig),o),Qt,Xt)}catch(d){throw c.create("fid-registration-failed",{errorInfo:d?.toString()})}if(r.ok)return{responseFid:await nn(r)};let a;try{a=await r.json()}catch{throw c.create("fid-registration-failed",{errorInfo:r.statusText})}const u=a.error?.message??r.statusText;throw c.create("fid-registration-failed",{errorInfo:u})}async function tn(e,t){const i={method:"DELETE",headers:await E(e)};let o;try{o=await fetch(`${v(e.appConfig)}/${t}`,i)}catch(r){throw c.create("fid-unregister-failed",{errorInfo:r?.toString()})}if(!o.ok)try{throw(await o.json()).error?.message??o.statusText}catch(r){throw c.create("fid-unregister-failed",{errorInfo:typeof r=="string"&&r||o.statusText||r?.toString()})}}async function nn(e){const t=await e.text();if(!t.trim())throw c.create("fid-registration-failed",{errorInfo:"CreateRegistration succeeded but response body is empty"});let n;try{n=JSON.parse(t)}catch{throw c.create("fid-registration-failed",{errorInfo:"CreateRegistration succeeded but response body is not valid JSON"})}const i=n.name;if(typeof i!="string"||i.length===0)throw c.create("fid-registration-failed",{errorInfo:"CreateRegistration succeeded but response did not include a non-empty name"});return on(i)}const se="/registrations/";function on(e){const t=e.indexOf(se);if(t!==-1){const n=e.slice(t+se.length);if(n.length>0)return n}throw c.create("fid-registration-failed",{errorInfo:"CreateRegistration succeeded but response name is not a valid registration resource name"})}async function rn(e,t){const n=await E(e),i=z(t.subscriptionOptions,e.appConfig.appName,!1),o={method:"PATCH",headers:n,body:JSON.stringify(i)};let r;try{r=await(await fetch(`${v(e.appConfig)}/${t.token}`,o)).json()}catch(a){throw c.create("token-update-failed",{errorInfo:a?.toString()})}if(r.error){const a=r.error.message;throw c.create("token-update-failed",{errorInfo:a})}if(!r.token)throw c.create("token-update-no-token");return r.token}async function Ke(e,t){const i={method:"DELETE",headers:await E(e)};try{const r=await(await fetch(`${v(e.appConfig)}/${t}`,i)).json();if(r.error){const a=r.error.message;throw c.create("token-unsubscribe-failed",{errorInfo:a})}}catch(o){throw c.create("token-unsubscribe-failed",{errorInfo:o?.toString()})}}async function an(e,t,n){let i;for(let o=0;o<t;o++)try{return await e()}catch(r){if(i=r,o<t-1){const a=n*Math.pow(2,o);await new Promise(u=>setTimeout(u,a))}}throw i}function v({projectId:e}){return`${$t}/projects/${e}/registrations`}async function E({appConfig:e,installations:t}){const n=await t.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e.apiKey,"x-goog-firebase-installations-auth":`FIS ${n}`})}function sn(e,t){try{if(/^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(e))return new URL(e).host}catch{}try{if(typeof self<"u"&&self.location?.href)return new URL(e,self.location.origin).host}catch{}return typeof self<"u"&&self.location?.host?self.location.host:t}function z({p256dh:e,auth:t,endpoint:n,vapidKey:i,swScope:o},r,a){const u={web:{origin:sn(o,r),endpoint:n,auth:t,p256dh:e}};return a&&(u.fcm_sdk_version=j),i!==De&&(u.web.applicationPubKey=i),u}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function He(e,t){if(!navigator)throw c.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw c.create("permission-blocked");return await qe(e,t?.vapidKey),await je(e,t?.serviceWorkerRegistration),un(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function x(e=Ve()){return S().then(t=>{if(!t)throw c.create("unsupported-browser")},t=>{throw c.create("indexed-db-unsupported")}),q(D(e),"messaging").getImmediate()}async function xn(e,t){return e=D(e),He(e,t)}function $n(e){return e=D(e),Pn(e)}function jn(e,t){return e=D(e),Kn(e,t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
