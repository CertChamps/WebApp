        ...
        <div className="flex w-full h-full">
            <div className="w-2/3 h-full overflow-y-scroll">          
                ...
                <div className="flex-1 h-full flex flex-col">
                    ...
                    {/* pinned footer */}
                    <div className="h-16 w-full p-4 shrink-0 flex items-center hover:opacity-90">
                            <a    href="https://discord.gg/E6N8ZTugUp"
                            target="_blank"
                        ...
                        <p className="txt mx-2">Join our discord to report bugs or suggest features!</p>
                    </div>
                </div>
        </div>
    )
